namespace NTShop.Data.Migrations
{
    ...
    public partial class InitialDB : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        MateKeyword = c.String(maxLength: 256),
                        MateDescription = c.String(maxLength: 256),
                        Status = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.ProductCategoryies", t => t.CategoryID, cascadeDelete: true)
                .Index(t => t.CategoryID);
            
            CreateTable(
                "dbo.ProductCategoryies",
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Products", "CategoryID", "dbo.ProductCategoryies");
            ...
            DropTable("dbo.Pages");
            DropTable("dbo.ProductCategoryies");
